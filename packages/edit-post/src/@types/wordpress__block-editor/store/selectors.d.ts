 ...
 */
export function getBlockMode( clientId: string ): string;
 ...
 */
export function getSelectionEnd(): Record< string, unknown >;
 ...
 */
export function getSelectionStart(): Record< string, unknown >;
